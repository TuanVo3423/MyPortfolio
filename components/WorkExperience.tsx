...
export default function WorkExperience({}: Props) {
  return (
    ...
    >
      ...
      <div className="w-full flex flex-row space-x-5 p-10 overflow-x-scroll snap-x snap-mandatory scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-secondary">
        <ExperienceCard />
        <ExperienceCard />
        <ExperienceCard />
      </div>
